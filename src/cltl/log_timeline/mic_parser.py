...
class MicLogParser(LogParser):
    START = 'Microphone muted'
    END = 'Microphone unmuted'

    def __init__(self, start_pattern: str = START, end_pattern: str = END):
        self._start = start_pattern
        self._end = end_pattern
        self._count = 0

    def is_logline(self, line: str) -> bool:
        return ('cltl.backend.impl.sync_microphone' in line
    ...
    def parse(self, line: str) -> Event:
        ...
        return Event((self._count, "MIC_MUTE"), start, end, None, None)
